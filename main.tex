...
% 表 4-8 等：勾选使用 pifont（Zapf Dingbats）\ding{51}，避免 TIMES.TTF 缺 U+2713 导致方框
\newcommand{\timescheck}{\mbox{\ding{51}}}
...
\addcommitteemember{西安交通大学副教授,金 莉}
...
% \usepackage{}
% placeins 由 XJTU-thesis.cls 按需加载；本章已不再使用 \FloatBarrier
